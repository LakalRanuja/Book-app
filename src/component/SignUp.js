    ...
    render() {
        return (
            <View style={styles.container }>
                <Image source={require('../assets/images/Capture.png')} style={{width: 100, height: 100, borderRadius: 15}}/>
                <Text style={styles.header}>Login</Text>
                <Text style={styles.header2}>Lorem ipsum dolor sit amet, consetetur sadipscing elitr</Text>
                <Text style={styles.txtUsName}>User Name</Text>
                <TextInput style={styles.inputUser} value={this.state.email}/>
                <Text style={styles.txtemail}>E-mail</Text>
                <TextInput style={styles.inputEmail} value={this.state.password} secureTextEntry={true}/>
                ...
                <TouchableOpacity style={{borderRadius: 40 , backgroundColor:'#000000', width: 80, height :40, textAlign: 'center', marginTop: 50}}>
                    <Text borderRadius="15px" style={{color: 'white', textAlign: 'center', position: 'relative', top: '25%' }}>Signup</Text>
                </TouchableOpacity>
            </View>
        );
    }
